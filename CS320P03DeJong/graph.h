...
// Stores: numVertices, vertexNames, adjMatrix
class Graph
{
private:
	size_t				 numVertices;
...
public:
	...
	// gets the cost of the edges.
	int getEdgeCost(unsigned int v1, unsigned int v2) const { return adjMatrix[v1][v2]; } //nums adjusted for starting at 0 instead of 1
